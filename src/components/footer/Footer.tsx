    ...
    <div className="container mx-auto w-full">
      <div className="grid grid-cols-1 gap-6 px-6 py-8 md:grid-cols-5">
        <div className="col-span-2">
          <Image src={logo} className="mb-4 h-[23px] w-[80px]" alt="logo" />
          ...
          <div className="text-white lg:mt-6">
            ...
            <br />
            <span>
              6th &amp; 9th fl, 570, Samseong-ro, Gangnam-gu,
              <br />
        ...
        <FooterItem
          ...
          contents={[
            ...
            {
              content: 'Contact Us',
              href: 'https://help.swit.io/?support=true',
            },
            { content: 'Blog', href: 'https://swit.io/blog/list/all' },
            {
              content: 'News',
              href: 'https://swit.io/news/list/press-release',
            },
            {
              content: 'Brand Guidelines',
              href: 'https://swit.io/brand-guideline',
            },
          ]}
        />
        <FooterItem
          ...
          contents={[
            ...
            {
              content: 'Project & Task Management',
              href: 'https://swit.io/project',
            },
        ...
        <FooterItem
          ...
          contents={[
            ...
            { content: 'Help Center', href: 'https://help.swit.io/' },
            {
              ...
              href: 'https://updates.swit.io/desktop',
            },
            {
              content: 'Terms of Service',
              href: 'https://swit.io/privacy?sub=swit-terms-of-service',
            },
            {
              content: 'Privacy policy',
              href: 'https://swit.io/privacy?sub=privacy-policy',
            },
      ...
      <hr className="h-px border-0 bg-white dark:bg-gray-700" />

      <div className="px-4 py-6 md:flex md:items-center md:justify-between">
        <div className="mb-4 flex space-x-6 sm:justify-center md:my-0">
          <FooterIcon
            href="https://www.facebook.com/GetSwit/?ref=br_rs"
            icon={
              <svg
          ...
          />
          <FooterIcon
            href="https://twitter.com/GetSwit"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
          ...
          />
          <FooterIcon
            href="https://www.youtube.com/channel/UCHwxFEV3a3ZZVO5uUzoSfCw"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
          ...
          />
          <FooterIcon
            href="https://www.instagram.com/getswit/"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
          ...
          />
          <FooterIcon
            href="https://www.linkedin.com/company/getswit"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
          ...
          />
          <FooterIcon
            href="https://www.tiktok.com/@getswit"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
          ...
          />
          <FooterIcon
            href="https://www.reddit.com/r/GetSwit"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
          ...
          />
          <FooterIcon
            href="https://www.pinterest.com/getswit"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
